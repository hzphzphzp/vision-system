...
class PerformanceMonitor:
    ...
    def __init__(self, sample_interval: float = 1.0, max_history: int = 3600):
        ...
        logger.info(
            f"性能监控器初始化完成: CPU核心数={self._cpu_count}, 采样间隔={sample_interval}s"
        )
    ...
    def record_inference(self, inference_time_ms: float):
        ...
        with self._lock:
            ...
            self._stats["avg_inference_time"] = (
                self._stats["total_inference_time"]
            ...
            if self._inference_times:
                ...
                self._current_metrics.fps = (
                    1000 / avg_time if avg_time > 0 else 0
                )
    ...
    def get_metrics_history(
        self, last_n_seconds: float = None, max_samples: int = None
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            if self._inference_times:
                ...
                stats["p95_inference_time"] = (
                    sorted_times[int(n * 0.95)]
                    if n >= 20
                    else sorted_times[-1]
                )
                stats["p99_inference_time"] = (
