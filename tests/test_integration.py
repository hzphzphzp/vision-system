...
def test_solution_file_manager():
    ...
    try:
        ...
        success = file_manager.save_solution(
            solution, json_file, format="json"
        )
        ...
        if success:
            ...
            # 测试JSON格式加载
            loaded_solution = file_manager.load_solution(
        ...
        success = file_manager.save_solution(
            solution, vmsol_file, format="vmsol"
        )
...
def test_communication_enhancements():
    ...
    try:
        from tools.communication import ReceiveData, SendData
...
def test_communication_monitor():
    ...
    try:
        ...
        from ui.communication_monitor import (
