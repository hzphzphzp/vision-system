...
from modules.cpu_optimization.core.parallel_engine import ParallelEngine, parallel_map, parallel_for_range, batch_process
from modules.cpu_optimization.core.memory_pool import MemoryPool, ImageMemoryPool, get_memory_pool, get_image_pool
from modules.cpu_optimization.core.simd_optimizations import SIMDOptimizer, get_simd_optimizer
...
class TestParallelEngine:
    ...
    def test_batch_process(self):
        ...
        # 测试批量处理
        results = batch_process(data, process_item, batch_size=20, show_progress=False)
