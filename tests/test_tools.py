...
class TestImageFilterTools:
    ...
    def test_box_filter(self, sample_image):
        """测试方框滤波工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "方框滤波", "box_filter")
    ...
    def test_mean_filter(self, sample_image):
        """测试均值滤波工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "均值滤波", "mean_filter")
    ...
    def test_gaussian_filter(self, sample_image):
        """测试高斯滤波工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "高斯滤波", "gaussian_filter")
    ...
    def test_median_filter(self, sample_image):
        """测试中值滤波工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "中值滤波", "median_filter")
    ...
    def test_bilateral_filter(self, sample_image):
        """测试双边滤波工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "双边滤波", "bilateral_filter")
    ...
    def test_morphology(self, sample_image):
        """测试形态学处理工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "形态学处理", "morphology_tool")
    ...
    def test_image_resize(self, sample_image):
        """测试图像缩放工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "图像缩放", "resize_tool")
...
class TestVisionTools:
    ...
    def test_gray_match(self, sample_image):
        ...
        tool.set_param("template_path", "nonexistent.jpg")  # 这会导致错误，但至少设置了参数
...
class TestRecognitionTools:
    ...
    def test_barcode_reader(self, sample_image):
        """测试条码识别工具"""
        tool = ToolRegistry.create_tool("Recognition", "条码识别", "barcode_reader")
    ...
    def test_qrcode_reader(self, sample_image):
        """测试二维码识别工具"""
        tool = ToolRegistry.create_tool("Recognition", "二维码识别", "qrcode_reader")
...
class TestToolEdgeCases:
    ...
    def test_tool_without_input(self):
        """测试工具在没有输入时的行为"""
        tool = ToolRegistry.create_tool("ImageFilter", "高斯滤波", "edge_case_tool")
    ...
    def test_tool_with_invalid_input(self, invalid_image):
        """测试工具在无效输入时的行为"""
        tool = ToolRegistry.create_tool("ImageFilter", "高斯滤波", "invalid_input_tool")
    ...
    def test_tool_with_invalid_params(self, sample_image):
        """测试工具在无效参数时的行为"""
        tool = ToolRegistry.create_tool("ImageFilter", "高斯滤波", "invalid_param_tool")
    ...
    def test_disabled_tool(self, sample_image):
        """测试禁用的工具"""
        tool = ToolRegistry.create_tool("ImageFilter", "高斯滤波", "disabled_tool")
