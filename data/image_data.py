...
class ImageData:
    ...
    def resize(self, width: int, height: int, 
               interpolation: int = None) -> 'ImageData':
        """
        调整图像大小
    ...
    @classmethod
    def create_empty(cls, width: int = 0, height: int = 0, 
                     channels: int = 1) -> 'ImageData':
        """
        创建空图像
    ...
    def __repr__(self) -> str:
        return (f"ImageData(width={self._width}, height={self._height}, "
...
class ResultData:
    ...
    def _detect_data_type(self, value: Any) -> DataType:
        ...
        if isinstance(value, bool):
            ...
            elif 'x1' in value and 'y1' in value and 'x2' in value and 'y2' in value:
    ...
    def get_values_with_types(self) -> List[Tuple[str, Any, DataType]]:
        """获取所有值及其类型"""
        return [(k, v, self._value_types.get(k, DataType.UNKNOWN)) 
