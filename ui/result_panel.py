...
class ResultItem:
    ...
    def __init__(self, result_type: ResultType, message: str, details: Dict[str, Any] = None, 
                 tool_name: str = None, timestamp: float = None):
...
class ResultPanelWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self.table_view.setHorizontalHeaderLabels(["时间", "类型", "工具", "消息"])
    ...
    def add_result(self, result_type: ResultType, message: str, details: Dict[str, Any] = None, 
                   tool_name: str = None):
        """添加结果
    ...
    def add_info(self, message: str, details: Dict[str, Any] = None, tool_name: str = None):
        """添加信息结果"""
        self.add_result(ResultType.INFO, message, details, tool_name)
    
    def add_success(self, message: str, details: Dict[str, Any] = None, tool_name: str = None):
        """添加成功结果"""
        self.add_result(ResultType.SUCCESS, message, details, tool_name)
    
    def add_warning(self, message: str, details: Dict[str, Any] = None, tool_name: str = None):
        """添加警告结果"""
        self.add_result(ResultType.WARNING, message, details, tool_name)
    
    def add_error(self, message: str, details: Dict[str, Any] = None, tool_name: str = None):
        """添加错误结果"""
        ...
        for result in self._results:
            ...
            if search_text:
                if search_text not in result.message.lower() and \
                   (result.tool_name is None or search_text not in result.tool_name.lower()):
                    continue
    ...
    def _update_display(self):
        ...
        self.filter_count_label.setText(f"{len(self._filtered_results)} 条过滤结果")
    ...
    def _update_table_view(self):
        ...
        for result in self._filtered_results:
            ...
            # 时间
            time_item = QTableWidgetItem(result.datetime.strftime("%Y-%m-%d %H:%M:%S.%f")[:-3])
