...
from core.communication.protocol_base import ProtocolBase, ConnectionState, DataParser, TextParser
...
class SerialPort(ProtocolBase):
    ...
    SUPPORTED_STOPBITS = [serial.STOPBITS_ONE, serial.STOPBITS_ONE_POINT_FIVE, serial.STOPBITS_TWO]
    SUPPORTED_PARITIES = [
        serial.PARITY_NONE, serial.PARITY_EVEN, 
...
if __name__ == "__main__":
    ...
    serial_port.register_callback("on_receive", lambda data: print(f"收到: {data}"))
