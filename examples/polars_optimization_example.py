...
from utils.performance_optimization import DataProcessor, benchmark_data_processing
...
def test_data_processing():
    ...
    # 生成测试数据
    test_results = [
        {"class": "person", "confidence": 0.95, "x": 100, "y": 200, "width": 50, "height": 100},
        {"class": "person", "confidence": 0.85, "x": 300, "y": 150, "width": 45, "height": 90},
        {"class": "car", "confidence": 0.90, "x": 50, "y": 300, "width": 100, "height": 60},
        {"class": "car", "confidence": 0.75, "x": 200, "y": 350, "width": 90, "height": 55},
        {"class": "dog", "confidence": 0.65, "x": 400, "y": 250, "width": 30, "height": 40},
    ]
