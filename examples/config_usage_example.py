...
from config.config_manager import (
    get_config, set_config, save_config, reload_config,
    get_full_config, update_config, validate_config
)
...
def test_default_values():
    ...
    # 获取不存在的配置，使用默认值
    non_existent_config = get_config('non_existent.section.key', 'default_value')
